        ...
        >
          ...
          <div style={{ display: "flex", gap: 5, alignItems: "center" }}>
            ...
            <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
              <path d="M8 11.5a1.25 1.25 0 100-2.5 1.25 1.25 0 000 2.5z" fill="#1A1A1E" />
              <path d="M5.17 8.33a4.002 4.002 0 015.66 0" stroke="#1A1A1E" strokeWidth="1.25" strokeLinecap="round" />
              <path d="M2.34 5.5a8.003 8.003 0 0111.32 0" stroke="#1A1A1E" strokeWidth="1.25" strokeLinecap="round" />
            </svg>
            <svg width="25" height="12" viewBox="0 0 25 12" fill="none">
              <rect x="0.5" y="0.5" width="21" height="11" rx="2" stroke="#1A1A1E" strokeOpacity="0.35" />
              <rect x="2" y="2" width="18" height="8" rx="1" fill="#1A1A1E" />
              <path d="M23 4v4a2 2 0 000-4z" fill="#1A1A1E" fillOpacity="0.4" />
            </svg>
          </div>
        </div>
